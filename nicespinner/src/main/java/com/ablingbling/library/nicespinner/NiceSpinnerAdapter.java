...
public class NiceSpinnerAdapter<T> extends NiceSpinnerBaseAdapter {
    ...
    NiceSpinnerAdapter(Context context, List<T> items, int textColor, int backgroundSelector, SpinnerTextFormatter spinnerTextFormatter, int paddingLeft, int paddingTop, int paddingRight, int paddingBottom) {
